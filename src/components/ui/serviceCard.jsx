  ...
  return (
    <div
      ...
      <style jsx global>{`
        ...
        /* Blur animations only on devices md and above (768px+) */
        @media (min-width: 768px) {
          ...
          /* Apply blur only during opacity transitions on md+ devices */
        ...
        /* On mobile (below md), only use opacity transitions without blur */
...
const SingleServiceCard = memo(function SingleServiceCard({
  ...
  return (
    <div
      {...props}
      className="single-service-card relative  h-[480px] md:h-[540px] rounded-[32px] shadow-lg border border-[#D3CAFD] overflow-hidden z-10 backdrop-blur-sm group">
        ...
        <div className="relative h-full w-full px-8 py-8">
          ...
          <div className="default-content absolute inset-0 px-8 py-8 h-full flex flex-col justify-between opacity-100 group-hover:opacity-0 transition-all duration-300 ease-in-out">
            <div>
              ...
              {/* 
              {description && (
                <P3 className="text-black-800 md:hidden mb-6">{description}</P3>
              )} */}
            </div>
