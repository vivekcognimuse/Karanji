...
export default function AvatarCard({ avatar }) {
  ...
  return (
    <div
      className="relative w-[340px] h-[422px] cursor-pointer flex-shrink-0"
      ...
      <div
        ...
        <div
          ...
          <div className="relative z-10 flex-1 flex flex-col justify-start space-y-4 pt-4">
            {avatar.expertise?.map((item, index) => (
              <React.Fragment key={index}>
                <P3 className="text-black-800 ">{item}</P3>
          ...
          <div className="relative z-10 mt-8 mx-auto w-full">
            <a target="_blank" href={avatar.ctaLink}>
              <Button variant="secondary" className="w-full px-4 ">
