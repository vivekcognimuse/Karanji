...
export async function POST(request) {
  ...
  console.log("=== CTA FORM API CALLED ===", {
  ...
  try {
    ...
    const { name, email, query, sourceUrl, pageTitle } = body;
    ...
    if (name.length > 100 || email.length > 254 || query.length > 5000) {
      return NextResponse.json(
        {
    ...
    const emailData = {
      ...
      subject: `New CTA Form Submission from ${escapeHtml(name)}`,
      html: `
        <!DOCTYPE html>
        <html lang="en">
        <head>
        ...
        <body>
          <div class="container">
            ...
            <div class="content">
              ...
              <div class="field">
                <span class="label">Query / Interest</span>
                <div class="value query-value">${escapeHtml(query)}</div>
              </div>
              ${
                sourceUrl
                  ? `
              <div class="field">
                ...
                <div class="value">
                  <a href="${escapeHtml(sourceUrl)}" class="url-link">
              ...
              <div class="field">
                ...
                <div class="value">${escapeHtml(pageTitle)}</div>
              </div>
              `
                  : ""
              }
            ...
            <div class="footer">
              <p>This is an automated notification from your website's CTA form.</p>
            </div>
          </div>
        </body>
        </html>
    ...
    console.error("Unexpected error in cta-form API:", error);
    return NextResponse.json(
      {
